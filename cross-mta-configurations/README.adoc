...
The values are usually provided by other MTAs during their deployments and most often contain allocated routes mapped to apps in those MTAs. Thus a 'service discovery' is achieved at deployment time.
