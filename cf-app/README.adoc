...
NOTE: See link:mta.yaml[mta.yaml] or link:mtad.yaml[mtad.yaml] for details on the attributes and environment and deployer parameters used. To learn more about what parameters are supported for CF apps, see the link:https://help.sap.com/docs/btp/sap-business-technology-platform/modules?ai=true&locale=en-US#module-specific-parameters[official documentation]
...
my-cf-app   started           1/1         1G       1G     orgname-spacename-my-mta-managed-app-module.cfapps.sap.hana.ondemand.com
```
...
routes:            orgname-spacename-my-mta-managed-app-module.cfapps.sap.hana.ondemand.com
